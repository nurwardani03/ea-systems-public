...
<head>
    ...
    <title>Login Auditor | E-Audit Systems</title>
...
<!-- Header EA Systems + Login Auditor -->
<div class="bg-gradient-to-r from-blue-500 to-blue-300 px-6 pt-5 pb-5 rounded-t-xl shadow text-center text-white">
    ...
    <p class="text-sm font-medium opacity-85 mt-1">Login Auditor</p>
</div>
        ...
        <div class="p-6 pt-2">
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" required autofocus
                           class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-sm text-sm">
                </div>
            ...
            <div class="mt-4 text-center">
                ...
                <a href="{{ route('register') }}" class="text-blue-600 hover:underline font-medium text-sm">Daftar Akun</a>
            </div>
        </div>
    </div>
    ...
    <div class="mt-3 text-center text-sm text-gray-500">
        ...
        <p>Status: <span class="font-medium text-green-600">Aktif</span></p>
    </div>
